...
const EditProduct = ({data:prevData,close}) => {
...
...summaryApi.UpdateProduct,data:data,
...
<div className="fixed inset-0 bg-black/30 backdrop-blur-sm flex items-center justify-center z-50">
  ...
  <div className="relative max-w-3xl w-full max-h-[90vh] overflow-y-auto mx-4 p-6 bg-white shadow-md rounded-2xl">
